<nav class="flex justify-around items-center outline py-4 fixed top-0 w-full bg-white z-10">
    ...
    <div class="flex">
        <input type="search" placeholder="Entrez le titre du livre..." name="" id="" class="py-2 px-4 mr-8 w-96 bg-['./images/loupe.png'] rounded-full border-2 border-emerald-400 ">
        <div class="ml-2 mr-6">
            <a href="#" class="text-[#4F4F4F] text-lg px-4 hover:text-black-900 inline-block transform transition-transform duration-300 hover:scale-110">Qui
                sommes-nous ?</a>
    ...
    <div class="flex">
        <?php if (isset($_SESSION['email-logged'])) : ?>
            <a href="#" class="flex items-center flex-col mx-4">
